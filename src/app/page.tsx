  ...
  return (
    <main>
      <header className="px-8 py-6 flex items-center justify-between border-b border-stone-200">
        <span className="font-serif text-xl tracking-wide text-stone-900">Dink Nolen III</span>
        <nav className="flex gap-8 text-sm text-stone-500">
          <a href="/gallery" className="hover:text-stone-900 transition-colors">Work</a>
      ...
      <section className="px-8 pt-24 pb-16 text-center">
        <p className="text-xs uppercase tracking-widest text-stone-400 mb-5">Charlotte, NC</p>
        <h1 className="font-serif text-5xl sm:text-6xl text-stone-900 leading-tight max-w-2xl mx-auto">
          From the<br />heart of the Carolinas
        </h1>
      </section>

      <section id="work" className="px-8 pb-24 max-w-7xl mx-auto">
        <p className="text-xs uppercase tracking-widest text-stone-400 mb-8">Featured Work</p>
        {artworks.length === 0 ? (
          <p className="text-stone-400 text-center py-16">No featured works yet.</p>
        ) : (
