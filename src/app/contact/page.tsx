  ...
  return (
    <main>
      ...
      <div className="px-8 py-20 max-w-2xl mx-auto">
        <p className="text-xs uppercase tracking-widest text-stone-400 mb-5">Contact</p>
        ...
        <div className="space-y-6 text-stone-700 leading-relaxed">
          <p>
            Interested in a piece, have a question about the work, or just want to say hello —
