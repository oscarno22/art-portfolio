      ...
      <div className="px-8 py-20 max-w-2xl mx-auto">
        ...
        <div className="space-y-6 text-navy/85 leading-relaxed">
          ...
          <p>
            ...
            the textures and rhythms of the Carolinas — raw and layered,
            unhurried but alive. He calls it Appalachian low-country punk: a
            sensibility that finds beauty in weathered things and honest places.
          </p>
          <p>
            His work is rooted in a simple belief: that where you&apos;re from
            shapes what you make, and that the heart of the Carolinas is worth
            putting on canvas.
          </p>
        </div>
